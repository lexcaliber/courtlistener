...
_GERUND = r"(?:\S+ing)"
_GERUND_THAT = rf"{_GERUND} that"
_HOLDING = r"(?:holding|observing|deciding|ruling|recognizing)"
_HOLDING_THAT = rf"{_HOLDING} that"
...
def description_score(
    ...
    if re.match(_HOLDING_THAT, description):
        ...
        score += 300
    # holding and synonyms are also pretty good
